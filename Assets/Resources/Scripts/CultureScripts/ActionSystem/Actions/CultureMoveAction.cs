...
public static class CultureMoveAction
{
    ...
    static IEnumerator MoveTile(CultureTurnInfo cultureTurnInfo, Culture culture, Tile targetTile)
    {
        ...
        Turn.AddStateUpdate(CultureUpdateGetter.GetStateUpdate(cultureTurnInfo, culture, Culture.State.NewOnTile));
        Turn.AddTileUpdate(CultureUpdateGetter.GetTileUpdate(cultureTurnInfo, culture, targetTile));
